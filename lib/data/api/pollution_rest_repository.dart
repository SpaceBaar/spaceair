import 'package:space_air/data/api/api_exception.dart';
import 'package:space_air/data/api/http_client.dart';
import 'package:space_air/data/serialization/pollution_data.dart';
import 'package:space_air/data/serialization/pollution_quality_index.dart';
import 'package:space_air/data/serialization/pollution_sensor.dart';
...
class PollutionRestRepository extends PollutionRepository {
  ...
  Future<List<PollutionSensor>> getSensors(int stationId) async {
    ...
    return sensorListJson
        .map((stationJson) => PollutionSensor.fromJson(stationJson))
        .toList();
  }
  ...
  Future<PollutionQualityIndex> getPollutionQualityIndex(int stationId) async {
    final Map<String, dynamic> pollutionQualityIndexJson = await _httpClient
