...
import 'package:space_air/data/serialization/index_level.dart';
...
class PollutionQualityIndex {
  ...
  factory PollutionQualityIndex.fromJson(Map<String, dynamic> json) =>
      _$PollutionQualityIndexFromJson(json);
