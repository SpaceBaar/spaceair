...
import 'package:space_air/data/serialization/sensor_parameter.dart';
...
class PollutionSensor {
  ...
  factory PollutionSensor.fromJson(Map<String, dynamic> json) =>
      _$PollutionSensorFromJson(json);
